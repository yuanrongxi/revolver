...
ICoreClientFrame::ICoreClientFrame()
{
    /*daemon_client_ = NULL;
    listener_= NULL;*/
    //udp_handler_ = NULL;
...
void ICoreClientFrame::release_handler()
{
    /*if(daemon_client_)
    {
...
void ICoreClientFrame::start(bool wan)
{
    /*if(daemon_client_)
    {
...
void ICoreClientFrame::bind_port(uint16_t port)
{
...
void ICoreClientFrame::create_daemon_client(IDaemonEvent * daemon_event, IDaemonConfig* config)
{
...
void ICoreClientFrame::create_udp()
{
...
void ICoreClientFrame::create_tcp_listener()
{
    /*if(listener_ == NULL)
        listener_ = new CCoreTCPListener();*/
}

void ICoreClientFrame::create_dc_client()
{
    /*if(dc_client_ == NULL)
    {
...
void ICoreClientFrame::attach_server_notify(ICoreServerNotify* notify)
{
...
uint32_t ICoreClientFrame::post_write_php(uint32_t dc_sid, CoreDCParam* param, const string& php, const string& php_param, bool ack /* = true */)
{
    uint32_t ret = 0;
    /*if(dc_client_ != NULL)
    {
...
CoreDCParam* ICoreClientFrame::cancel_dc_request(uint32_t exc_id)
{
...
int32_t ICoreClientFrame::post_node_state(const string& node_info)
{
    int32_t ret = -1;
    /*if(daemon_client_ != NULL)
    {
